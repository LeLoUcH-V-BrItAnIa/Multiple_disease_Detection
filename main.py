...
from flask_api.recommender import build_prompt
import requests
...
if selected == 'Diabetes Prediction':
    ...
    # 🧠 Get AI-based Remedies
        with st.spinner("Fetching health suggestions..."):
            ai_response = get_remedies(user_inputs_dict, diab_prediction[0])
...
<div style="text-align:center;">
    🧠 Built with ❤️ by Kaustav | Powered by Gemini API
